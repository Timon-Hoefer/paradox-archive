(()=>{
  ...
  const chapterFiles=['zenos-gate.html','power-relay.html','oracles-drop.html','endless-corridor.html','the-final-question.html'];
  const PROGRESS_KEY='paradox-archive-progress-v2';
  function readProgress(){try{let value=localStorage.getItem(PROGRESS_KEY);if(value==='hilberts-hotel.html')value='endless-corridor.html';return chapterFiles.includes(value)?value:null}catch{return null}}
  ...
  function clearProgress(){try{localStorage.removeItem(PROGRESS_KEY);localStorage.removeItem('paradox-archive-progress-v1')}catch{}}
  ...
  const transitionCopy={
    ...
    'the-final-question.html':{en:['the corridor folded behind you','the archive recognizes its traveller','one question survived the darkness'],de:['der korridor faltete sich hinter dir zusammen','das archiv erkennt seinen reisenden','eine frage überlebte die dunkelheit']}
  };
  ...
  const chapterClass={'paradox-archive.html':'chapter-index','zenos-gate.html':'chapter-zeno','oracles-drop.html':'chapter-oracle','endless-corridor.html':'chapter-corridor','power-relay.html':'chapter-relay','the-final-question.html':'chapter-final'}[fileName(location.href)];
