(()=>{
  const exact=new Map(Object.entries({
    ...
    "Chapter 05 · Emergency Power":"Kapitel 05 · Notstrom","Chapter 04 · Emergency Power":"Kapitel 04 · Notstrom","Final query · The Answer":"Letzte Anfrage · Die Antwort","Emergency power lost.":"Notstrom ausgefallen.","Restore all relays. Open the final hatch.":"Aktiviere alle Relais. Öffne die letzte Schleuse.","power://local_grid":"strom://lokales_netz","final hatch // sealed":"letzte schleuse // verriegelt","node_05 // circuit restored":"node_05 // stromkreis wiederhergestellt","node_04 // circuit restored":"node_04 // stromkreis wiederhergestellt","The hatch is open.":"Die Schleuse ist offen.","Every switch changed more than itself.":"Jeder Schalter veränderte mehr als nur sich selbst.","Emergency relay panel":"Notstrom-Relaisfeld","Sealed final hatch":"Verriegelte letzte Schleuse","Open final query →":"Letzte Anfrage öffnen →",
  ...
  const chapterFiles=['zenos-gate.html','oracles-drop.html','endless-corridor.html','power-relay.html','the-final-question.html'];
  ...
  const transitionCopy={
    ...
    'oracles-drop.html':{en:['the gate has stopped running','a signal fell through branching futures','something is waiting below'],de:['das tor flieht nicht mehr','ein signal fiel durch verzweigte zukünfte','etwas wartet dort unten']},
