(()=>{
  ...
  async function restart(){restartButton.disabled=true;clearProgress();await resetSession();const url=new URL('zenos-gate.html',location.href);if(lang==='de')url.searchParams.set('lang','de');else url.searchParams.delete('lang');location.href=url.href}
