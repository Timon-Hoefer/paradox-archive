(()=>{
  const exact=new Map(Object.entries({
    ...
    "Chapter III — The Endless Corridor":"Kapitel III — Der endlose Korridor",
    "Chapter V — Emergency Power":"Kapitel V — Notstrom",
    "Chapter IV — Emergency Power":"Kapitel IV — Notstrom",
    "Chapter II — Emergency Power":"Kapitel II — Notstrom",
    "Chapter V — The Final Question":"Kapitel V — Die letzte Frage",
    "Final Query — The Paradox Archive":"Letzte Anfrage — Das Paradox-Archiv",
    ...
    "Zeno's Gate":"Zenons Tor","Hilbert's Infinite Hotel":"Hilberts unendliches Hotel","The Oracle's Drop":"Der Fall des Orakels","The Endless Corridor":"Der endlose Korridor","Emergency Power":"Notstrom","The Final Question":"Die letzte Frage",
    ...
    "The first threshold":"Die erste Schwelle","The corridor continues":"Der Korridor geht weiter","Go backward one room":"Einen Raum zurückgehen","A path has appeared":"Ein Weg ist erschienen","The exit was behind you.":"Der Ausgang lag hinter dir.",
    ...
    "The archive has lost its logic. Recover five mathematical nodes. Each accepts a different kind of proof.":"Das Archiv hat seine Logik verloren. Stelle fünf mathematische Knoten wieder her. Jeder verlangt eine andere Art von Beweis.","The archive has lost its logic. Recover four mathematical nodes. Each accepts a different kind of proof.":"Das Archiv hat seine Logik verloren. Stelle vier mathematische Knoten wieder her. Jeder verlangt eine andere Art von Beweis.","The archive has lost its logic. Recover its mathematical nodes. Each accepts a different kind of proof.":"Das Archiv hat seine Logik verloren. Stelle seine mathematischen Knoten wieder her. Jeder verlangt eine andere Art von Beweis.","The four nodes":"Die vier Knoten","The archive nodes":"Die Knoten des Archivs","Node 01":"Knoten 01","Node 02":"Knoten 02","Node 03":"Knoten 03","Node 04":"Knoten 04","Node 05":"Knoten 05","Initialize session →":"Sitzung initialisieren →","paradox/os · recovery mode":"paradox/os · Wiederherstellungsmodus",
    "Start Journey":"Reise starten","Visual riddles. No instructions. No prior knowledge required.":"Visuelle Rätsel. Keine Anleitung. Kein Vorwissen nötig.","run node_01":"node_01 starten","node_01 // cleared":"node_01 // abgeschlossen","Space collapsed.":"Raum kollabiert.","The gate needed infinite room. You removed the room.":"Das Tor brauchte unendlichen Raum. Du hast den Raum entfernt.","Open node 02 →":"Knoten 02 öffnen →",
    "Path lattice":"Pfadgitter","Stop the orb.":"Halte die Kugel auf.","Drag four blocks onto the paths.":"Ziehe vier Blockaden auf die Wege.","Run node 02":"Knoten 02 starten","Run node 03":"Knoten 03 starten","node_02 // live":"node_02 // aktiv","Close the lattice.":"Schließe das Gitter.","network //":"netzwerk //","15 nodes":"15 Knoten","entry":"eingang","exit":"ausgang","blocks":"blöcke","Release":"Start","Clear":"Leeren","minimum vertex cut // verified":"minimaler Knotenschnitt // bestätigt","Every path is closed.":"Jeder Weg ist geschlossen.","Four vertices separate every entry from every exit.":"Vier Knoten trennen jeden Eingang von jedem Ausgang.","Open node 03 →":"Knoten 03 öffnen →",
    ...
    "Find the exit.":"Finde den Ausgang.","Each door creates another room. The archive records every step.":"Jede Tür erzeugt einen weiteren Raum. Das Archiv speichert jeden Schritt.","Enter":"Betreten","room_00 // changed":"raum_00 // verändert","The exit is open.":"Der Ausgang ist offen.","Exit":"Verlassen","node_04 // inverse path restored":"node_04 // umgekehrter Pfad wiederhergestellt","Backward erased the maze.":"Rückwärts löschte das Labyrinth.","The last room entered was the first one left.":"Der zuletzt betretene Raum wurde zuerst verlassen.","Open node 05 →":"Knoten 05 öffnen →",
    "Chapter V — The Observer's Vault":"Kapitel V — Das Gewölbe des Beobachters","Chapter 05 · The Observer's Vault":"Kapitel 05 · Das Gewölbe des Beobachters","The Observer's Vault":"Das Gewölbe des Beobachters","The archive knows when it is being watched.":"Das Archiv weiß, wann es beobachtet wird.","A watched and sealed vault door":"Eine beobachtete und versiegelte Gewölbetür","observation://active":"beobachtung://aktiv","node_05 // observer absent":"node_05 // beobachter abwesend","Unseen, the lock released.":"Unbeobachtet gab das Schloss nach.","The vault could not remain certain without a witness.":"Ohne Zeugen konnte das Gewölbe nicht gewiss bleiben.",
    "Chapter 05 · Emergency Power":"Kapitel 05 · Notstrom","Chapter 04 · Emergency Power":"Kapitel 04 · Notstrom","Chapter 02 · Emergency Power":"Kapitel 02 · Notstrom","Final query · The Answer":"Letzte Anfrage · Die Antwort","Emergency power lost.":"Notstrom ausgefallen.","Restore all relays. Open the final hatch.":"Aktiviere alle Relais. Öffne die letzte Schleuse.","Restore all relays. Open the next hatch.":"Aktiviere alle Relais. Öffne die nächste Schleuse.","power://local_grid":"strom://lokales_netz","final hatch // sealed":"letzte schleuse // verriegelt","archive hatch // sealed":"archivschleuse // verriegelt","node_05 // circuit restored":"node_05 // stromkreis wiederhergestellt","node_04 // circuit restored":"node_04 // stromkreis wiederhergestellt","node_02 // circuit restored":"node_02 // stromkreis wiederhergestellt","The hatch is open.":"Die Schleuse ist offen.","Every switch changed more than itself.":"Jeder Schalter veränderte mehr als nur sich selbst.","Emergency relay panel":"Notstrom-Relaisfeld","Sealed final hatch":"Verriegelte letzte Schleuse","Sealed archive hatch":"Verriegelte Archivschleuse","Open final query →":"Letzte Anfrage öffnen →",
    "Life. Universe. Everything.":"Leben. Universum. Der ganze Rest.","archive // unlocked":"archiv // entsperrt","Session complete.":"Sitzung abgeschlossen.","Continue journey →":"Reise fortsetzen →",
  ...
  const patterns=[
    ...
    [/^Blocker junction, channel (\d+), level (\d+)$/,m=>`Blockierbarer Knoten, Kanal ${m[1]}, Ebene ${m[2]}`],[/^Open entry gate (\d+)$/,m=>`Offenes Eingangstor ${m[1]}`],[/^Exit road (\d+)$/,m=>`Ausgangsweg ${m[1]}`],[/^Seal stone (.+)$/,m=>`Siegelstein ${m[1]}`],[/^Drag seal stone (.+) onto a junction$/,m=>`Ziehe Siegelstein ${m[1]} auf einen Knoten`],
  ...
  async function resetSession(){try{await fetch('/api/reset-session',{method:'POST',credentials:'same-origin',headers:{Accept:'application/json'}})}catch{}}
  async function restart(){restartButton.disabled=true;clearProgress();await resetSession();const url=new URL('paradox-archive.html',location.href);if(lang==='de')url.searchParams.set('lang','de');else url.searchParams.delete('lang');location.href=url.href}
  function addInterface(){
    const style=document.createElement('style');
    style.textContent=':root{--pa-terminal-accent:#d97757;--pa-terminal-font:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}body,button,input,textarea{font-family:var(--pa-terminal-font)!important}.intro-copy,.brief-copy,.journey,.mission,.epilogue p,.reference,.completion,.message{font-family:var(--pa-terminal-font)!important}#pa-language{position:fixed;z-index:2000;right:12px;bottom:12px;display:flex;gap:3px;padding:4px;border:1px solid #46413b;border-radius:8px;background:rgba(24,23,21,.94);box-shadow:0 12px 36px rgba(0,0,0,.24);font:700 10px/1 var(--pa-terminal-font)}#pa-language button{min-width:32px;height:28px;padding:0;border:0;border-radius:5px;background:transparent;color:#99958d;cursor:pointer}#pa-language .pa-restart{min-width:auto;padding:0 10px;margin-right:3px;color:#cbc6bc}#pa-language button[aria-pressed="true"]{background:rgba(217,119,87,.2);color:#f2c1ad}#pa-transition{position:fixed;z-index:5000;inset:0;display:grid;place-items:center;padding:24px;background:#1d1c1a;color:#d6d1c7;font-family:var(--pa-terminal-font)}.pa-terminal-window{width:min(720px,100%);border:1px solid #47423c;border-radius:10px;background:#242320;box-shadow:0 30px 90px rgba(0,0,0,.42);overflow:hidden}.pa-terminal-head{padding:11px 15px;border-bottom:1px solid #3d3934;color:#8e8980;font-size:11px;letter-spacing:.06em}.pa-terminal-output{min-height:190px;padding:24px 20px;font-size:clamp(13px,1.7vw,16px);line-height:1.75}.pa-terminal-line{display:flex;gap:11px;min-height:1.75em}.pa-terminal-prompt{color:var(--pa-terminal-accent)}.pa-terminal-cursor{display:inline-block;width:8px;height:1.05em;margin-left:3px;vertical-align:-.12em;background:var(--pa-terminal-accent);animation:pa-blink .8s steps(1) infinite}.pa-passage{position:relative;height:58px;margin:0 20px 15px;overflow:hidden;border-bottom:1px solid rgba(130,232,151,.16);opacity:.62}.pa-door{position:absolute;right:7%;bottom:0;width:27px;height:44px;border:1px solid var(--pa-terminal-accent);border-bottom:0;box-shadow:0 0 16px rgba(130,232,151,.1)}.pa-door::after{content:"";position:absolute;right:4px;top:22px;width:2px;height:2px;background:var(--pa-terminal-accent);box-shadow:0 0 5px var(--pa-terminal-accent)}.pa-person{position:absolute;left:5%;bottom:2px;width:18px;height:38px;color:var(--pa-terminal-accent);transform-origin:50% 100%;animation:pa-cross 3.5s .25s cubic-bezier(.32,.02,.35,1) both}.pa-head{position:absolute;left:5px;top:0;width:8px;height:8px;border:1px solid currentColor;border-radius:50%}.pa-torso{position:absolute;left:8px;top:9px;width:1px;height:15px;background:currentColor}.pa-arm,.pa-leg{position:absolute;left:8px;width:1px;background:currentColor;transform-origin:top}.pa-arm{top:12px;height:12px}.pa-arm.a{animation:pa-limb .42s ease-in-out infinite alternate}.pa-arm.b{animation:pa-limb .42s ease-in-out infinite alternate-reverse}.pa-leg{top:23px;height:14px}.pa-leg.a{animation:pa-leg .42s ease-in-out infinite alternate}.pa-leg.b{animation:pa-leg .42s ease-in-out infinite alternate-reverse}@keyframes pa-blink{50%{opacity:0}}@keyframes pa-cross{0%{left:5%;opacity:0;transform:scale(1)}8%{opacity:.9}70%{left:80%;opacity:.75;transform:scale(.9)}88%{left:88%;opacity:.32;transform:scale(.48)}100%{left:91%;opacity:0;transform:scale(.12)}}@keyframes pa-limb{from{transform:rotate(48deg)}to{transform:rotate(-48deg)}}@keyframes pa-leg{from{transform:rotate(34deg)}to{transform:rotate(-34deg)}}@media(prefers-reduced-motion:reduce){.pa-terminal-cursor{animation:none}.pa-person{display:none}}';
    style.textContent+=`
      ...
      @media(max-width:760px){.intro-inner,.epilogue-card,.epilogue-inner,.ending-inner,.check-card{padding:20px!important}.chapter-oracle .game{height:calc(100dvh - 60px);grid-template-columns:1fr}.chapter-oracle .side.right{position:static;right:auto;bottom:auto;width:auto}.chapter-final .question{gap:28px}}
    `;
  ...
  const chapterFiles=['zenos-gate.html','power-relay.html','oracles-drop.html','endless-corridor.html','observers-vault.html','the-final-question.html'];
  const PROGRESS_KEY='paradox-archive-progress-v3';
  function readProgress(){try{let value=localStorage.getItem(PROGRESS_KEY);if(!value){value=localStorage.getItem('paradox-archive-progress-v2');if(value==='the-final-question.html')value='observers-vault.html';if(value)localStorage.setItem(PROGRESS_KEY,value)}if(value==='hilberts-hotel.html')value='endless-corridor.html';return chapterFiles.includes(value)?value:null}catch{return null}}
  function saveProgress(target){const next=chapterFiles.indexOf(target);if(next<0)return;const current=chapterFiles.indexOf(readProgress());if(next>current)try{localStorage.setItem(PROGRESS_KEY,target)}catch{}}
  function clearProgress(){try{localStorage.removeItem(PROGRESS_KEY);localStorage.removeItem('paradox-archive-progress-v2');localStorage.removeItem('paradox-archive-progress-v1');sessionStorage.removeItem('pa-archive-occlusion')}catch{}}
  function addContinue(){if(fileName(location.href)!=='paradox-archive.html')return;const saved=readProgress(),index=chapterFiles.indexOf(saved);if(index<=0)return;const row=document.querySelector('.action-row');if(!row)return;const link=document.createElement('a');link.id='pa-continue';link.className='begin';link.href=saved;link.textContent='Continue journey →';row.appendChild(link)}
  const transitionCopy={
    'zenos-gate.html':{en:['the archive woke before you','someone erased its final proof','the first lock is still moving'],de:['das archiv erwachte vor dir','jemand löschte seinen letzten beweis','das erste schloss bewegt sich noch']},
    'power-relay.html':{en:['the gate has stopped running','the archive diverts you below ground','an emergency grid is still breathing'],de:['das tor flieht nicht mehr','das archiv leitet dich unter die erde','ein notstromnetz atmet noch']},
    'oracles-drop.html':{en:['the current is flowing again','a signal split into branching futures','something is waiting below'],de:['der strom fließt wieder','ein signal teilte sich in verzweigte zukünfte','etwas wartet dort unten']},
    'endless-corridor.html':{en:['the oracle has gone silent','the next corridor remembers every step','forward may not mean escape'],de:['das orakel ist verstummt','der nächste korridor erinnert jeden schritt','vorwärts bedeutet nicht unbedingt flucht']},
    'observers-vault.html':{en:['the corridor folded behind you','a sealed vault watches every movement','some locks weaken without a witness'],de:['der korridor faltete sich hinter dir zusammen','ein versiegeltes gewölbe beobachtet jede bewegung','manche schlösser werden ohne zeugen schwach']},
    'the-final-question.html':{en:['the watcher has closed its eye','the archive recognizes its traveller','one question survived the darkness'],de:['der wächter hat sein auge geschlossen','das archiv erkennt seinen reisenden','eine frage überlebte die dunkelheit']}
  };
  ...
  async function streamTransition(href,target){
    ...
    const head=document.createElement('div');head.className='pa-terminal-head';head.textContent='archive://intercepted_transmission';
    const output=document.createElement('div');output.className='pa-terminal-output';
    const passage=document.createElement('div');passage.className='pa-passage';passage.setAttribute('aria-hidden','true');const doorMark=document.createElement('span');doorMark.className='pa-door';const traveller=document.createElement('span');traveller.className='pa-person';for(const className of ['pa-head','pa-torso','pa-arm a','pa-arm b','pa-leg a','pa-leg b']){const part=document.createElement('span');part.className=className;traveller.appendChild(part)}passage.append(traveller,doorMark);
    windowEl.append(head,output,passage);overlay.appendChild(windowEl);document.body.appendChild(overlay);
    ...
    const hold=reduced?650:4000;for(let waited=0;waited<hold&&!skip;waited+=50)await pause(50);saveProgress(target);location.href=href;
  }
  ...
  const chapterClass={'paradox-archive.html':'chapter-index','zenos-gate.html':'chapter-zeno','oracles-drop.html':'chapter-oracle','endless-corridor.html':'chapter-corridor','power-relay.html':'chapter-relay','observers-vault.html':'chapter-observer','the-final-question.html':'chapter-final'}[fileName(location.href)];
  if(chapterClass)document.body.classList.add(chapterClass);
  addInterface();addContinue();translateTree(document.documentElement);decorateLinks();bindTransitions();
